...
00`: `a` is `0001 1146` and `b` is `1010 1100`, so a `Z` bit is `b`
...
records the vector with the bit imposed: `1000` at time 0, `1146`
...
50 ns, `0001`, `0001`, `0101`, `1146`, the pulled bits resolving to
`1` one at a time.
...
`t62_str_vec_1drv` holds `XXXX`, `0000`, `1146`.
...
`XXXX` at time 0 and `ZZZ1` for `1146` at 50 ns.
