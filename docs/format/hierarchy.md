...
| `t54_nosig_var___` | those and `env` | none | `0xcb8` | `0x1107` |
...
16 to 24 bytes.
*Confirmed by* the region length check in 1107 of 1107 cases, and the
...
and *confirmed by* the reader's range check in 1107 of 1107 cases and
