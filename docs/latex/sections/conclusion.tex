...
The forge is private because of the runner. Every corpus case is a
...
homelab, but it answers to the private forge and is not integrated
with GitHub, so a public repository there would have nothing to build
or test this work with.

If you would like the source in a public place and are willing to
sponsor a GitHub runner that can hold a Vivado installation, please
get in touch through \url{https://hdlfactory.com}. That is the one
thing standing between this work and a public mirror.
